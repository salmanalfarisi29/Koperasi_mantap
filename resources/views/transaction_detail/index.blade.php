...
@section('breadcrumb')
    @parent
    <li class="active">transactions Penjaualn</li>
@endsection
    ...
    <div class="col-lg-12">
        <div class="box">
            ...
            <div class="box-footer">
                <button type="submit" class="btn btn-primary btn-sm btn-flat pull-right btn-simpan"><i class="fa fa-floppy-o"></i> Simpan transactions</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $(function () {
        ...
        table = $('.table-penjualan').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '{{ route('transactions.data', $id_transaksi) }}',
            },
            columns: [
    ...
    function loadForm(diskon = 0, diterima = 0) {
        ...
        $('#jumlah_beli').val($('.jumlah_beli').text());

        $.get(`{{ url('/transactions/loadform') }}/${diskon}/${$('.total').text()}/${diterima}`)
            .done(response => {
