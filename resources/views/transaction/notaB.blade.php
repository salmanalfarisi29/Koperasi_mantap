    ...
    <table class="data" width="100%">
        ...
        <tfoot>
            <tr>
                ...
                <td class="text-right"><b>{{ format_uang($transactions->total_harga) }}</b></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="text-right"><b>{{ format_uang($transactions->uang_pembayaran) }}</b></td>
            </tr>
            <tr>
                <td colspan="6" class="text-right"><b>Kembali</b></td>
                <td class="text-right"><b>{{ format_uang($transactions->uang_pembayaran - $transactions->total_harga) }}</b></td>
            </tr>
        </tfoot>
    </table>
